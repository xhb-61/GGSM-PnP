...
def define_Dataset(dataset_opt):
    ...
    elif dataset_type in ['rician']:
        from data.dataset_rician import DatasetRician as D
    ...
    # common
    # -----------------------------------------
    elif dataset_type in ['plain2']:
        from data.dataset_plain2 import DatasetPlain2 as D
